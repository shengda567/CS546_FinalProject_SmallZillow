...
async function main() {
  ...
  console.log("  ");
  console.log("  ");
  console.log('please take 2 minutes rest for your health! initial data will take some time, thank you for your patient');
  console.log("we need initial 7 managers, to verify them will take some time")
    ...
    if(!manager1 || !manager2 || !manager3 || !manager4 || !manager5 || !manager6 || !manager7){
    ...
    if(!register1 || !register2 || !register3 || !register4 ||
      !register5 || !register6 || !register7 || !register8 ||
      !register9 || !register11 || !register12 || !register13 ||
      !register14 || !register15 || !register16 || !register10){
    ...
    if(!comment1 || !comment2 || !comment3 || !comment4 ||
